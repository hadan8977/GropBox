...
1. Open **Deploy with Vercel** in the [README](../README.md#deploy-yourself). Sign in to Vercel, choose your own team/account, connect your GitHub account, and choose the owner and name of the repository copy. The button creates that copy and a Next.js project; it does not create Supabase tables or configure Google.
